...
console.log(data)
  ...
  return (
    <div className='container'>
      <h2 className='header'>Hostel Count in Each Destination</h2>
      <div className='hostelcount-container'>
        {data.hostelCountByDestination.map((ele) => (
          <div key={ele.destination._id} className='grid-body'>
            <div className='image-container'><img src={ele.destination.image} alt='image'/></div>
